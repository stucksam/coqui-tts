...
GENERATED_SPEECH_FOLDER_LONG = GENERATED_SPEECH_FOLDER + "_gpt_long"
GENERATED_SPEECH_PATH_LONG = f"{OUT_PATH}/{XTTS_MODEL_TRAINED}/{GENERATED_SPEECH_FOLDER_LONG}"
TEXT_METADATA_FILE_LONG = TEXT_METADATA_FILE.replace(".txt", "_gpt_long.txt")
TEXT_TRANSCRIBED_FILE_LONG = TEXT_TRANSCRIBED_FILE.replace(".txt", "_gpt_long.txt")
